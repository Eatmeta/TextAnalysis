...
namespace TextAnalysis
{
    ...
    public class SentencesParser_Tests
    {
        ...
        protected static void AssertAllSentencesEqual(List<List<string>> expectedSentences,
            List<List<string>> actualSentences, string text)
        {
        ...
        protected static void AssertSentenceEuqal(List<string> expected, List<string> actual, string text, int sentenceNumber)
        {
